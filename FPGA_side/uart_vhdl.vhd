...
ENTITY uart_VHDL IS
  GENERIC(
    ...
    baud_rate :  INTEGER    := 1_000_000  ;      --data link baud rate in bits/second
    os_rate   :  INTEGER    := 1;          --oversampling rate to find center of receive bits (in samples per baud period)
...
ARCHITECTURE logic OF uart_VHDL IS
